...
from 整体月报数据 import generate_sales_trend_chart_html, get_fenxiao_data
...
def test_trend_chart():
    ...
    try:
        ...
        # 保存测试结果
        test_filename = 'test_trend_chart_result.html'
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 趋势图修复测试通过！")
        print("📋 请打开 test_trend_chart_result.html 查看效果")
    else:
        print("\n💥 趋势图修复测试失败！") 