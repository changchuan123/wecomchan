...
def final_trend_fix():
    ...
    content = content.replace(
        ...
        function updateSummaryDisplay() {
            ...
            if (currentTrendFilter.category || currentTrendFilter.shop || currentTrendFilter.product) {
                ...
                summaryDiv.innerHTML = '<div style="background: #e3f2fd; padding: 10px; border-radius: 5px; margin-bottom: 15px; text-align: center;">' +
                ...
                // 没有筛选条件，显示全部当天数据
                summaryDiv.innerHTML = '<div style="background: #f3e5f5; padding: 10px; border-radius: 5px; margin-bottom: 15px; text-align: center;">' +
    ...
    print("6. 使用字符串拼接避免了f-string嵌套问题")
